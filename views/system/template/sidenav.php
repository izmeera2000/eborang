<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
  ...
  <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="<?php echo $rootPath; ?>/pages/profile.html">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="<?php echo $rootPath; ?>/pages/sign-in.html">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link  " href="<?php echo $rootPath; ?>/pages/sign-up.html">
          <div
            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <?php if ($_SESSION['user_details']['role'] == '4') { ?>
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#projectsExample" class="nav-link collapsed" aria-controls="projectsExample"
            ...
            <span class="nav-link-text ms-1">Perlepasan</span>
          </a>
          <div class="collapse" id="projectsExample" style="">
            <ul class="nav ms-4 ps-3">
              ...
              <li class="nav-item ">
                <a class="nav-link " href="<?php echo $rootPath; ?>/perlepasan/senarai">
                  <span class="sidenav-mini-icon"> S </span>
                  <span class="sidenav-normal"> Senarai </span>
                </a>
              </li>
      ...
      <?php if ($_SESSION['user_details']['role'] == '1') { ?>
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#staff" class="nav-link collapsed" aria-controls="projectsExample"
            role="button" aria-expanded="false">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg"
  ...
  <div class="sidenav-footer mx-3 ">
    <!-- <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      <div class="full-background"
        style="background-image: url('<?php echo $rootPath; ?>/assets/img/curved-images/white-curved.jpg')"></div>
