<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
  ...
  <div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        foreach ($breadcrumbs as $index => $breadcrumb) {
          ...
          if ($index === count($breadcrumbs) - 1) {
            echo '<li class="breadcrumb-item text-sm text-dark active" aria-current="page">';
            echo htmlspecialchars($breadcrumb['title']);
            echo '</li>';
          } else {
            echo '<li class="breadcrumb-item text-sm">';
            echo '<a class="opacity-5 text-dark" href="' . htmlspecialchars($breadcrumb['url']) . '">';
            echo htmlspecialchars($breadcrumb['title']);
            echo '</a>';
            echo '</li>';
          }
      ...
      <h6 class="font-weight-bolder mb-0"><?php echo htmlspecialchars(end($breadcrumbs)['title']); ?>
      </h6>
    </nav>
